    ...
    <main id="main-content">
      ...
      <section className="hero shell" id="top">
        ...
        <p className="hero-copy">
          Community Cuts for Kids brought young people, families, volunteers,
          and local supporters into the same space. ASC3ND is building from
          that day with more ways for young people to find guidance, practice
          life skills, and connect with opportunity.
        </p>
        <a className="text-link" href="#impact">
          Start with Community Cuts ↓
        </a>
      </section>
      ...
      <section className="impact" id="impact">
        <div className="shell impact-intro">
          ...
          <h2>It started with Community Cuts for Kids.</h2>
        </div>
      ...
      <section className="story shell" id="story">
        ...
        <div className="story-copy">
          ...
          <h2>Keep showing up after the event ends.</h2>
          <p>
            ASC3ND starts with a simple belief: young people need trusted adults,
            useful experiences, and a community that stays involved. Community
            Cuts gave us a place to begin. The work now is to keep building.
          </p>
      ...
      <section className="pathways shell" id="pathways">
        ...
        <h2>Three areas we are building now.</h2>
        <DocumentaryFrame
          label="Approved ASC3ND pathway image or brand video"
          slot="pathways"
        />
      ...
      <section className="take-part shell" id="take-part">
        ...
        <h2>Want to be part of what comes next?</h2>
        <DocumentaryFrame
